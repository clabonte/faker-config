<?php
namespace FakerConfig;

use Faker\Generator;

/**
 * Class ConfigGuesser
 * This class defines a guesser that can be configured to return/override a specific format to use for an
...
class ConfigGuesser
{
    ...
    public function guessFormat($entity, $property)
    {
        ...
        } elseif (isset($this->formats[$wildcard])) {
