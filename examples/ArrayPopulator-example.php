...
use FakerConfig\Populator\ArrayPopulator;
...
$populator = new ArrayPopulator($generator, $guesser);
...
$populator2 = new ArrayPopulator($generator, $guesser, new \Faker\Guesser\Name($generator));
