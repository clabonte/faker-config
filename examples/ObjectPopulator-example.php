...
use FakerConfig\ConfigGuesserLoader;
use FakerConfig\Populator\ObjectPopulator;
...
$guesser = new ConfigGuesser($generator);
ConfigGuesserLoader::loadFile($guesser, __DIR__ . '/example-config.json');

// Create an ObjectPopulator to fill up your objects based on configuration only
$populator = new ObjectPopulator($generator, $guesser);
...
$populator2 = new ObjectPopulator($generator, $guesser, new \Faker\Guesser\Name($generator));
