<?php
namespace FakerConfig\Populator;


use Faker\Factory;
use Faker\Generator;
use Faker\Guesser\Name;
use FakerConfig\ConfigGuesser;
use FakerConfig\Format;
...
class ObjectPopulatorTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $guesser->addFormat('FakerConfig\Populator\GrandParent', 'name', new Format('lastName'));
        $guesser->addFormat('FakerConfig\Populator\GrandParent', 'origin', new Format('country'));
        $guesser->addFormat('GrandParent', 'unused', new Format('sentence'));
        $guesser->addFormat('FakerConfig\Populator\Father', 'firstName', new Format('firstNameMale'));
        $guesser->addFormat('FakerConfig\Populator\Father', 'origin', new Format('city'));
        $guesser->addFormat('FakerConfig\Populator\Father', 'job', new Format('company'));
        $guesser->addFormat('FakerConfig\Populator\Child', 'firstName', new Format('firstNameFemale'));
        $guesser->addFormat('FakerConfig\Populator\Child', 'job', new Format('jobTitle'));
        $guesser->addFormat('FakerConfig\Populator\Child', 'phone', new Format('phoneNumber'));
        $guesser->addFormat('FakerConfig\Populator\Child', 'note', new Format('sentence'));
    ...
    {
        $this->guesser->addFormat('FakerConfig\Populator\Child', 'unsettable', new Format('sentence'));
